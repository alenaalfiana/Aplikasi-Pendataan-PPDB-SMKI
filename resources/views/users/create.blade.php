                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="kabupaten" name="regency_id" class="form-select select2" required disabled>
                                                    <option value="">-- Pilih Kabupaten/Kota --</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="kecamatan" class="form-label">Kecamatan</label>
                                                <select id="kecamatan" name="district_id" class="form-select select2" required disabled>
                                                    <option value="">-- Pilih Kecamatan --</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="desa" class="form-label">Desa/Kelurahan</label>
                                                <select id="desa" name="village_id" class="form-select select2" required disabled>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="border p-2 rounded">
                                                    ...
                                                    <div class="mt-2 d-flex gap-2">
                                                        <button type="button" class="btn btn-sm btn-danger" id="clear-signature">Hapus</button>
                                                        <div class="input-group">
                                                            <input type="file" class="form-control form-control-sm"
                                                            id="upload-signature" accept="image/png,image/jpeg">
                                                        </div>
                                                    </div>
                                                    <small class="text-muted">Anda bisa menggambar tanda tangan atau mengunggah gambar (format PNG/JPEG).</small>
                                                </div>
                                            </div>
