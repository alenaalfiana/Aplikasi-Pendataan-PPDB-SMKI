...
<div class="container">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <strong>Periode:</strong> {{ $laporanPenerimaan->periode->nama_periode }}<br>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <strong>Organisasi Sekolah:</strong> {{ $reportData['interview']->organisasi_sekolah ?? 'Tidak ada' }}<br>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <strong>Biaya Hidup per Bulan:</strong> {{ $reportData['survey']->biaya_hidup_perbulan ?? 'Tidak ada' }}<br>
                    <strong>Alasan Pendukung:</strong> {{ $reportData['survey']->alasan_pendukung ?? 'Tidak ada' }}
                </div>
                <div class="col-md-6">
    ...
    <div class="mt-3">
        ...
        <a href="{{ route('laporan-penerimaan.download-ppt', $laporanPenerimaan->id_penerimaan) }}" class="btn btn-primary">
            Unduh PowerPoint
        </a>
        @endif
    </div>
